...
namespace AP.MobileToolkit.Controls.Platform.Droid
{
    ...
    public class HtmlTagHandler : Java.Lang.Object, Android.Text.Html.ITagHandler
    {
        ...
        private const int listItemIndent = indent * 2;

        private static readonly BulletSpan bullet = new BulletSpan(indent);
         ...
         */
        readonly Stack<string> lists = new Stack<string>();

        /**
         * Tracks indexes of ordered lists so that after a nested list ends
         * we can continue with correct index of outer list
         */
        readonly Stack<int> olNextIndex = new Stack<int>();
