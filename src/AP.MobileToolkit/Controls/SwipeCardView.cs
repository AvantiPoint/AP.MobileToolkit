...
namespace AP.MobileToolkit.Controls
{
    public class SwipeCardView : ContentView
    {
        ...
        public void SendSwiped(View sender, SwipeCardDirection direction)
        {
        ...
        [EditorBrowsable(EditorBrowsableState.Never)]
        public void SendDragging(View sender, SwipeCardDirection direction, DraggingCardPosition position, double distanceDraggedX, double distanceDraggedY)
        {
